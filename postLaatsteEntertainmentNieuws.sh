...
docker exec  raspiblog_python_1 python /scripts/maakEntertainmentBlogPost.py >> LaatsteNieuwsBlog.log
docker exec  raspiblog_python_1 python /scripts/TrendingBlogPost.py Entertainment >> LaatsteNieuwsBlog.log
